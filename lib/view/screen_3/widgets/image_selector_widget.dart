  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        Row(
          children: [
            Text(imageSelectorHeadings[rowIndex]),
            kWidth10, 
            Text(
              "(${imageSelectorHeadings2[rowIndex]})",
                      ...
                      children: [
                        ClipRRect(
                          ...
                          child: Container(
                            ...
                            child: controller.pickedFilesLists[rowIndex]
                                        [columnIndex] !=
                                    null
                                ? Image.file(
                                    File(controller
                                        .pickedFilesLists[rowIndex]
                                            [columnIndex]!
                                        .path),
                                    fit: BoxFit.cover,
                                  )
                        ...
                        controller.pickedFilesLists[rowIndex][columnIndex] !=
                            ...
                            ? Positioned(
                                ...
                                child: Container(
                                  ...
                                  child: InkWell(
                                      onTap: () {
                                        controller.pickedFilesLists[rowIndex]
                                            [columnIndex] = null;
